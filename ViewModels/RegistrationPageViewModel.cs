...
namespace PhoneBook.ViewModels
{
    class RegistrationPageViewModel : ViewModelBase
    {
        ...
        public string Username
        {
            ...
            set
            {
                if (username != value)
                {
                    ...
                    HandleErrorUsername();//name validation
                }
        ...
        public bool CanAddUser
        {
            get
            {
                return !(HasErrorName || HasErrorUsername || HasErrorPassword);
            }
        }
        ...
        private void HandleErrorUsername()
        {
            ErrorMessageUsername = string.Empty;
            if (!ValidUsername())
            {
                ErrorMessageUsername = "The name is too short or consists invalid characters";
            }

            OnPropertyChanged(nameof(HasErrorUsername));
            OnPropertyChanged(nameof(CanAddUser));
        }
        ...
        private void AddNewUser(string name)
        {
            ...
            contactService.Register(newUser);
